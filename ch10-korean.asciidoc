...
// 번역자노트
// cryptozeny
// 1. 번역하며 이해가 안 가는 부분은 다음과 같이 red 처리하였다.
// [red]#이해안가는부분#
